function [Ft Tt IXTt Xs XtTraining Wt Ht XvTraining Wv]=nmf_clustering_multimodal_asymmetric (r)
concepts=10;
images=10;
...
save('Fv.mat', 'Fv');
save('Tt.mat', 'Tt');
save('imgIds.mat', 'imgIdsTraining');
