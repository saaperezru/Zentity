...
%% build the pyramid
[mRows mColumns] = GenerateSiftDescriptors( imageFileList,imageBaseDir,dataBaseDir,maxImageSize,gridSpacing,patchSize,canSkip);
CalculateDictionary(imageFileList,dataBaseDir,'_dct.mat',dictionarySize,numTextonImages,canSkip,mRows,mColumns);
pyramid_all = BuildHistograms(imageFileList,dataBaseDir,'_dct.mat',dictionarySize,canSkip);
