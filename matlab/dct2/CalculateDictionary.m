function [ ] = CalculateDictionary( imageFileList, dataBaseDir, featureSuffix, dictionarySize, numTextonImages, canSkip, mRows, mColumns )
...
outFName = fullfile(dataBaseDir, sprintf('dictionary_dct_%d.mat', dictionarySize));
...
for f = 1:numTextonImages    
    ...
    sift_all(lastRowPosition:lastRowPosition+ndata-1,:) = features.data';
    
    lastRowPosition = lastRowPosition + ndata;
...
%save train_patches.mat sift_all;
